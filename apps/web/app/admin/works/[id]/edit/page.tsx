...
import { AutoCrawlPanel } from "@/components/AutoCrawlPanel";
...
export default function EditWorkPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const [activeTab, setActiveTab] = useState<'edit' | 'crawl'>('edit');
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded shadow">
            ...
            <div className="flex gap-2 mb-6 border-b">
                <button
                    ...
                    className={`px-4 py-2 font-medium transition ${activeTab === 'edit'
            ...
            {/* Auto-Crawl Tab */}
            {activeTab === 'crawl' && (
                <AutoCrawlPanel workId={id} workTitle={title} />
            )}
        </div>
    );
}
